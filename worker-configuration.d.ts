/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fbd2edefada28b77f7def75445dc9c73)
...
declare namespace Cloudflare {
	interface Env {
		...
		AI: Ai;
		MCP_TOOLS_URL: string; // Secret: MCP tools endpoint URL
        MODEL_PROVIDER: string // Secret: Model provider, e.g: "openai" or "azure"
        AI_AZURE_RESOURCE_NAME: string; // Secret: Azure OpenAI endpoint URL
        AI_AZURE_API_KEY: string; // Secret: Azure OpenAI API key
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IS_LOCAL">> {}
}
