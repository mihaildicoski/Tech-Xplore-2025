// Heads up: For most use cases, you will likely NOT need to edit this file
...
export function getModel(model : LanguageModelV1 | undefined) : LanguageModelV1
{
  return model !== undefined ? model : (() => { throw new Error("Model is not defined. Please check your environment configuration."); })()
}
